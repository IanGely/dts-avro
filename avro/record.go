...
type Record struct {
	...
	// time when this record is processed along the stream dataflow
		...
		ProcessTimestamps *UnionNullArrayInt
...
func writeRecord(r *Record, w io.Writer) error {
	...
	err = vm.WriteInt( r.SourceTimestamp, w)
	if err != nil {
		return err			
	}
	...
	err = writeUnionNullArrayInt( r.ProcessTimestamps, w)
	if err != nil {
		return err			
	}
...
func (r *Record) Get(i int) types.Field {
	...
	case 2:
			...
			return (*types.Int)(&r.SourceTimestamp)
	...
	case 9:
			...
			r.ProcessTimestamps = NewUnionNullArrayInt()
